...
return preact.h("p",null,preact.h("i",{"class":"fa fa-refresh fa-spin","aria-hidden":true})," ",preact.h("em",null,TL(["Loading..."])));
...
preact.h("th",null),
preact.h("th",null,TL(["Name"])),
preact.h("th",{style:{textAlign:'center'}},preact.h("abbr",{title:TL(["Elo rating"])},"Elo")),
preact.h("th",{style:{textAlign:'center'}},
preact.h("abbr",{title:TL(["user's percentage chance of winning a random battle (Glicko X-Act Estimate)"])},"GXE")
),
preact.h("th",{style:{textAlign:'center'}},
preact.h("abbr",{title:TL(["Glicko-1 rating system: rating\xB1deviation (provisional if deviation>100)"])},"Glicko-1")
),
...
preact.h("em",null,TL(["No one has played any ranked games yet."]))
))
);
};_proto.
...
preact.h("i",{"class":"fa fa-chevron-left","aria-hidden":true})," ",TL(["[All formats]"])
)
),
...
preact.h("i",{"class":"fa fa-trophy","aria-hidden":true})," ",TL(["[Seasonal rankings]"])
),
this.renderSearch()
),
this.renderHeader(),
...
LadderListPanel=function(_PSRoomPanel2){function LadderListPanel(){return _PSRoomPanel2.apply(this,arguments)||this;}_inheritsLoose(LadderListPanel,_PSRoomPanel2);LadderListPanel.
...
return TL(["Ladder"]);
};var _proto2=LadderListPanel.prototype;_proto2.
...
return preact.h("p",null,TL(["Loading..."]));
}
var currentSection="";
...
preact.h("div",{"class":"ladder pad"},
preact.h("p",null,
preact.h("a",{"class":"button",href:"//"+Config.routes.users+"/",target:"_blank"},
TL(["[Look up a specific user's rating]"])
)
),
preact.h("p",null,
preact.h("button",{"data-href":"view-ladderhelp","class":"button"},
preact.h("i",{"class":"fa fa-info-circle","aria-hidden":true})," ",TL(["[How the ladder works]"])
)
),
this.renderList()
)
