...
preact.h("em",null,team.isBox?TL(["(empty box)"]):TL(["(empty team)"])));
...
contents=[
preact.h("em",null,TL(["Select a team"]))];
...
preact.h("p",null,TL(["This team selector is no longer available (the challenge was cancelled or something)."])),
...
preact.h("i",{"class":"fa fa-folder-o","aria-hidden":true})," [",baseGen,"] ",preact.h("em",null,TL(["(uncategorized)"]))
)," ",
preact.h("button",{
"class":'button'+(baseGen===this.gen?' disabled':''),onClick:this.setFormat,name:"gen",value:baseGen},

preact.h("i",{"class":"fa fa-folder-o","aria-hidden":true})," [",baseGen,"] ",preact.h("em",null,TL(["(all)"]))
)," ",
hasOtherGens&&!this.gen&&
preact.h("button",{"class":"button",onClick:this.setFormat,name:"gen",value:baseGen},TL(["[Other gens]"]))

));

if(hasOtherGens&&this.gen){
teamList.push(preact.h("h2",null,TL(["[Other gens]"])));
...
preact.h("i",{"class":"fa fa-folder-o","aria-hidden":true})," [",gen,"] ",preact.h("em",null,TL(["(all)"]))
),
" "];}
)));
}
...
teamList,
isEmpty&&preact.h("p",null,preact.h("em",null,TL(["No teams found"])))
));
...
return preact.h(PSPanelWrapper,{room:room},
preact.h("div",{"class":"pad"},
preact.h("p",null,TL(["This format selector is no longer available."])),
preact.h("p",{"class":"buttonbar"},
preact.h("button",{type:"button","data-cmd":"/close","class":"button"},
TL(["[Close]"])
)
...
preact.h("button",{onClick:this.toggleGen,value:"gen9","class":"button button-first"+curGen('gen9')},TL(["Gen ",""],9)),
...
format.section==='No Format'&&preact.h("em",null," ",TL(["(uncategorized)"])),
...
noResults&&preact.h("p",null,preact.h("em",null,searchID?TL(["No formats matching \"","\" found"],searchID):TL(["No formats found"]))),
